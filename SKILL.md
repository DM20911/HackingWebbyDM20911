...
## 5. Tooling — instalación bajo demanda

Antes de invocar una herramienta, **verifica si está instalada**. Si no, **orienta la instalación** brevemente:
...
11. Remediación (inmediata, recomendada, hardening adicional)
12. Referencias (OWASP, CWE, CVE, PortSwigger, MITRE, NIST)
